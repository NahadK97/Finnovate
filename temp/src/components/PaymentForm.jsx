...
const PaymentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Error: ${err.message || "API Connection Error"}`);
      setResult(null);
    } finally {
      setLoading(false);
    }
    ...
    <div className={`dashboard ${themeClass}`}>
      ...
      <div className="form-panel">
        <form onSubmit={handleSubmit}>
          <h2>
            {currentStep === 1 ? "Transaction Details" : "Risk Parameters"}
          </h2>
          ...
          <div
            ...
            style={{
              transform:
                currentStep === 1 ? "translateX(0%)" : "translateX(-50%)",
            }}
          >
            {/* --- SLIDE 1: Amount --- */}
